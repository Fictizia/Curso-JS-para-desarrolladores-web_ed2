...
$(function(){
  ...
  var TodoList = Backbone.Firebase.Collection.extend({
    ...
    firebase: new Firebase("https://js-web-developers.firebaseio.com/todos"),
  ...
  var AppView = Backbone.View.extend({
    ...
    createOnEnter: function(e) {
      ...
      var authData = Todos.firebase.getAuth();
      
      if (authData) {
        Todos.add({title: this.input.val(), 'authUser': authData.facebook.displayName});
        this.input.val('');
      } else {
